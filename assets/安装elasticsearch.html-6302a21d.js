import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,a as e}from"./app-2135ced4.js";const t={},p=e(`<h1 id="安装elasticsearch" tabindex="-1"><a class="header-anchor" href="#安装elasticsearch" aria-hidden="true">#</a> 安装elasticsearch</h1><h1 id="_1-部署单点es" tabindex="-1"><a class="header-anchor" href="#_1-部署单点es" aria-hidden="true">#</a> 1.部署单点es</h1><h2 id="_1-1-创建网络" tabindex="-1"><a class="header-anchor" href="#_1-1-创建网络" aria-hidden="true">#</a> 1.1.创建网络</h2><p>因为我们还需要部署kibana容器，因此需要让es和kibana容器互联。这里先创建一个网络：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> network create es-net
