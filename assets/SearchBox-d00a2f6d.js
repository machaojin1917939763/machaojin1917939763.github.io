import{h as y,i as A,w as f,f as O,t as P,u as _,l as x,o as p,c as g,m as w,n as N,d as S,p as k,q as L,F as M,x as b,y as R,z as E,A as Q}from"./app-3e5aeb98.js";import{_ as q}from"./plugin-vue_export-helper-c27b6911.js";const J=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/blog/",title:"🚀 Java 面试探索之路",pathLocale:"/",contents:[{header:"🚀 Java 面试探索之路",slug:"🚀-java-面试探索之路",content:`欢迎你的莅临!
...
`},...o],page:e,content:null,parentPagePriority:10,priority:10})}}function B(e){const n=e.path.split("/");let i="/";return n[1]&&(i=`/${n[1]}/`),(F.value.get(i)||e).title}function C(e,n){const i=[];let r=0;const l=e.toLowerCase().replace(/\s/gu," ");let o=0,t=l.indexOf(n,o);if(t<0)return null;for(;t>=0;){const a=t+n.length;if(d(e.slice(o,t),"normal"),d(e.slice(t,a),"highlight"),o=a,t=l.indexOf(n,o),r>100)break}return d(e.slice(o),"normal"),i.filter(a=>a.str);function d(a,s){let c=a;s==="normal"&&c.length>100&&r===0&&(c=`… ${c.slice(-10)}`);let m=!1;if(r+c.length>100){if(i.some(h=>h.type==="ellipsis"))return;c=c.slice(0,Math.max(100-r,1)),m=!0}i.push({type:s,str:c}),r+=c.length,m&&(i.push({type:"ellipsis",str:" …"}),r+=2)}}const V={"/":{placeholder:"搜索"}},G=O({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>V}},setup(e){const{locales:n}=P(e),i=y(""),r=y(!1),l=y(-1),o=j(i),t=A(()=>i.value&&r.value&&o.value.length),d=_(),a=x(),s=A(()=>n.value[a.value]??{});function c(){if(!t.value)return;let u=l.value-1;u<0&&(u=o.value.length-1),h(u)}function m(){if(!t.value)return;let u=l.value+1;u>=o.value.length&&(u=0),h(u)}function h(u){l.value=u}function I(){l.value=-1}function D(u){if(!t.value)return;const v=o.value[u];v&&d.push(v.path)}return{query:i,focused:r,focusIndex:l,suggestions:o,activeSuggestion:t,onUp:c,onDown:m,focus:h,unfocus:I,go:D,locale:s}}});const K={class:"search-box",role:"search"},W=["placeholder"],z=["onMousedown","onMouseenter"],Y=["href"],X={key:0,class:"parent-page-title"},Z={class:"suggestion-row"},$={class:"page-title"},ee={class:"suggestion-content"};function ne(e,n,i,r,l,o){return p(),g("div",K,[w(S("input",{ref:"input","onUpdate:modelValue":n[0]||(n[0]=t=>e.query=t),"aria-label":"Search",class:k({focused:e.focused}),placeholder:e.locale.placeholder??"Search",autocomplete:"off",spellcheck:"false",onFocus:n[1]||(n[1]=()=>e.focused=!0),onBlur:n[2]||(n[2]=()=>e.focused=!1),onKeyup:[n[3]||(n[3]=L(t=>e.go(e.focusIndex),["enter"])),n[4]||(n[4]=L((...t)=>e.onUp&&e.onUp(...t),["up"])),n[5]||(n[5]=L((...t)=>e.onDown&&e.onDown(...t),["down"]))]},null,42,W),[[N,e.query]]),e.activeSuggestion?(p(),g("ul",{key:0,class:"suggestions",onMouseleave:n[7]||(n[7]=(...t)=>e.unfocus&&e.unfocus(...t))},[(p(!0),g(M,null,b(e.suggestions,(t,d)=>(p(),g("li",{key:d,class:k(["suggestion",{focused:d===e.focusIndex}]),onMousedown:a=>e.go(d),onMouseenter:a=>e.focus(d)},[S("a",{href:t.path,onClick:n[6]||(n[6]=Q(()=>{},["prevent"]))},[t.parentPageTitle&&(!e.suggestions[d-1]||e.suggestions[d-1].parentPageTitle!==t.parentPageTitle)?(p(),g("div",X,E(t.parentPageTitle),1)):R("v-if",!0),S("div",Z,[S("div",$,E(t.title||t.path),1),S("div",ee,[(p(!0),g(M,null,b(t.display,(a,s)=>(p(),g("span",{key:s,class:k(a.type)},E(a.str),3))),128))])])],8,Y)],42,z))),128))],32)):R("v-if",!0)])}const re=q(G,[["render",ne],["__scopeId","data-v-c13c90dc"],["__file","SearchBox.vue"]]);export{re as default};
