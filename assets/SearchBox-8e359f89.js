import{f as y,h as A,w as f,i as O,t as P,u as _,j as x,o as p,c as g,k as w,v as Q,d as S,l as k,m as L,F as M,p as b,q as I,s as E,x as N}from"./app-50f4b308.js";import{_ as q}from"./plugin-vue_export-helper-c27b6911.js";const J=[{path:"/",title:"项目主页",pathLocale:"/",contents:[{header:"",slug:"",content:`::: vue-playground 在线代码
@file PASS.vue
<template> <div id="app"> <div class="box" v-bind:style="{ background: gradient }"> <div class="text">OK,YOU PASSED!</div> </div> </div>
</template> <script>
export default { name: "App", data() { return { gradient: "linear-gradient(red, blue)", }; }, mounted() { // 每隔两秒就调用changeGradient方法 setInterval(this.changeGradient, 2000); }, methods: { changeGradient() { // 随机生成两个十六进制颜色 let randomColor1 = "#" + Math.floor(Math.random() * 16777215).toString(16); let randomColor2 = "#" + Math.floor(Math.random() * 16777215).toString(16); // 创建一个线性渐变的背景 this.gradient = \`linear-gradient(\${randomColor1}, \${randomColor2})\`; }, },
};
<\/script> <style>
.box { width: 100vw; height: 100vh;
} .text { font-size: 24px; text-align: center; vertical-align: middle; line-height: 100vh; overflow: hidden; white-space: nowrap;
}
</style> :::`}]},{path:"/blog/",title:"🚀 Java 面试探索之路",pathLocale:"/",contents:[{header:"🚀 Java 面试探索之路",slug:"🚀-java-面试探索之路",content:`::: tip
​ 欢迎你的莅临!
