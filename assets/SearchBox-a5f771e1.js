import{h as y,i as T,w as f,f as O,t as P,u as _,l as x,o as p,c as g,m as Q,n as w,d as S,p as k,q as L,F as M,x as b,y as I,z as E,A as N}from"./app-fe15e87e.js";import{_ as q}from"./plugin-vue_export-helper-c27b6911.js";const J=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/blog/",title:"🚀 Java 面试探索之路",pathLocale:"/",contents:[{header:"🚀 Java 面试探索之路",slug:"🚀-java-面试探索之路",content:`欢迎你的莅临!
这是我的 Java 面试准备之旅,记录我的面试经历与 Java 知识点总结。`},{header:"🧭 导航",slug:"🧭-导航",content:`Java 基础
数据结构与算法
设计模式
面试经验分享
...
💌 给我发邮件`},{header:"📣 声明",slug:"📣-声明",content:"所有内容都基于个人经验，希望能帮助大家，但也可能存在误区，欢迎指正。"}]},{path:"/code/",title:"🚀 Java 面试探索之路",pathLocale:"/",contents:[{header:"🚀 Java 面试探索之路",slug:"🚀-java-面试探索之路",content:`欢迎你的莅临!
这是我的 Java 面试准备之旅,记录我的面试经历与 Java 知识点总结。`},{header:"🧭 导航",slug:"🧭-导航",content:`Java 基础
数据结构与算法
设计模式
面试经验分享
...
实践：Java 微服务框架选择
Java 并发编程中的陷阱`},{header:"面试经验 🌈",slug:"面试经验-🌈",content:""},{header:"🎤 我的观点",slug:"🎤-我的观点",content:"在编程中，不仅是技能的积累，更重要的是经验与思维方式的培养。只有深入理解，才能在面试中轻松应对。"},{header:"🤝 加入我们",slug:"🤝-加入我们",content:`你也有什么经验、问题或者建议吗？欢迎分享或提问！ ✍️ 提交你的故事或问题
💌 给我发邮件`},{header:"📣 声明",slug:"📣-声明",content:"所有内容都基于个人经验，希望能帮助大家，但也可能存在误区，欢迎指正。"}]},{path:"/guide/",title:"🚀 Java 面试探索之路",pathLocale:"/",contents:[{header:"🚀 Java 面试探索之路",slug:"🚀-java-面试探索之路",content:`欢迎你的莅临!
这是我的 Java 面试准备之旅,记录我的面试经历与 Java 知识点总结。`},{header:"🧭 导航",slug:"🧭-导航",content:`Java 基础
数据结构与算法
设计模式
面试经验分享
...
实践：Java 微服务框架选择
Java 并发编程中的陷阱`},{header:"面试经验 🌈",slug:"面试经验-🌈",content:""},{header:"🎤 我的观点",slug:"🎤-我的观点",content:"在编程中，不仅是技能的积累，更重要的是经验与思维方式的培养。只有深入理解，才能在面试中轻松应对。"},{header:"🤝 加入我们",slug:"🤝-加入我们",content:`你也有什么经验、问题或者建议吗？欢迎分享或提问！ ✍️ 提交你的故事或问题
💌 给我发邮件`},{header:"📣 声明",slug:"📣-声明",content:"所有内容都基于个人经验，希望能帮助大家，但也可能存在误区，欢迎指正。"}]},{path:"/interview/",title:"🚀 Java 面试探索之路",pathLocale:"/",contents:[{header:"🚀 Java 面试探索之路",slug:"🚀-java-面试探索之路",content:`欢迎你的莅临!
这是我的 Java 面试准备之旅,记录我的面试经历与 Java 知识点总结。`},{header:"🧭 导航",slug:"🧭-导航",content:`Java 基础
数据结构与算法
设计模式
面试经验分享
...
image-20221012182744115 登陆MySQL数据库系统
# 执行
mysql -uroot -p
# 解释
# -u，登陆的用户，MySQL数据库的管理员用户同Linux一样，是root
# -p，表示使用密码登陆 # 执行完毕后输入刚刚得到的初始密码，即可进入MySQL数据库
image-20221012182805966 修改root用户密码
# 在MySQL控制台内执行
...
image-20221012183746802 至此，MySQL就安装完成并可用了，请妥善保存好MySQL的root密码。`},{header:"MySQL8.0版本在CentOS系统安装",slug:"mysql8-0版本在centos系统安装",content:"注意：安装操作需要root权限"},{header:"安装",slug:"安装",content:`配置yum仓库
# 更新密钥
...
MySQL默认绑定了3306端口，可以通过端口占用检查MySQL的网络状态
netstat -anp | grep 3306
image-20221012192303607 至此，MySQL就安装完成并可用了，请妥善保存好MySQL的root密码。`},{header:"MySQL5.7版本在Ubuntu（WSL环境）系统安装",slug:"mysql5-7版本在ubuntu-wsl环境-系统安装",content:`课程中配置的WSL环境是最新的Ubuntu22.04版本，这个版本的软件商店内置的MySQL是8.0版本
...
image-20221016094103315 配置apt仓库
# 使用dpkg命令安装仓库
...
最后选择：ok
image-20221016094306917 更新apt仓库的信息
# 首先导入仓库的密钥信息
...
看到如图所示字样，即成功 安装MySQL5.7
# 使用apt安装mysql客户端和mysql服务端
apt install -f -y mysql-client=5.7* mysql-community-server=5.7*
弹出框中输入root密码并选择ok，密码任意，课程中以123456代替
image-20221016094941439
再次输入root密码确认
image-20221016094954505 启动MySQL
/etc/init.d/mysql start # 启动
/etc/init.d/mysql stop # 停止
/etc/init.d/mysql status # 查看状态
image-20221016095259172 对MySQL进行初始化
# 执行如下命令，此命令是MySQL安装后自带的配置程序
mysql_secure_installation
# 可以通过which命令查看到这个自带程序所在的位置
root@DESKTOP-Q89USRE:~# which mysql_secure_installation
/usr/bin/mysql_secure_installation 输入密码：
image-20221016095458755 是否开启密码验证插件，如果需要增强密码安全性，输入y并回车，不需要直接回车（课程中选择直接回车）
image-20221016095537716 是否更改root密码，需要输入y回车，不需要直接回车（课程不更改）
image-20221016095621386 是否移除匿名用户，移除输入y回车，不移除直接回车（课程选择移除）
image-20221016101232827 是否进制root用户远程登录，禁止输入y回车，不禁止直接回车（课程选择不禁止）
image-20221016101324577 是否移除自带的测试数据库，移除输入y回车，不移除直接回车（课程选择不移除）
image-20221016101404392 是否刷新权限，刷新输入y回车，不刷新直接回车（课程选择刷新）
image-20221016101442459 登陆MySQL
mysql -uroot -p
# 输入密码即可登陆成功
image-20221016101524498 至此，在Ubuntu上安装MySQL5.7版本成功。`},{header:"MySQL8.0版本在Ubuntu（WSL环境）系统安装",slug:"mysql8-0版本在ubuntu-wsl环境-系统安装",content:`课程中配置的WSL环境是最新的Ubuntu22.04版本，这个版本的软件商店内置的MySQL是8.0版本
所以直接可以通过apt安装即可 注意，课程是以WSL获得的Ubuntu操作系统环境。
如果你通过VMware虚拟机的方式获得了Ubuntu操作系统环境，操作步骤不用担心，和课程中使用WSL环境是完全一致的 安装操作需root权限，你可以： 通过 sudo su -，切换到root用户 课程中选择这种方式操作 或在每一个命令前，加上sudo，用来临时提升权限`},{header:"安装",slug:"安装-2",content:`如果已经安装过MySQL5.7版本，需要卸载仓库信息哦
# 卸载MySQL5.7版本
...
image-20221016101324577 是否移除自带的测试数据库，移除输入y回车，不移除直接回车（课程选择不移除）
image-20221016101404392 是否刷新权限，刷新输入y回车，不刷新直接回车（课程选择刷新）
image-20221016101442459 重新登陆MySQL（用更改后的密码）
mysql -uroot -p
image-20221016110414182 至此，在Ubuntu上安装MySQL5.7版本成功。`},{header:"Tomcat安装部署【简单】",slug:"tomcat安装部署【简单】",content:""},{header:"简介",slug:"简介",content:`Tomcat 是由 Apache 开发的一个 Servlet 容器，实现了对 Servlet 和 JSP 的支持，并提供了作为Web服务器的一些特有功能，如Tomcat管理和控制平台、安全域管理和Tomcat阀等。
...
在页面下方找到： 下载jdk-8u351-linux-x64.tar.gz
image-20221017163440491
在弹出的页面中输入Oracle的账户密码即可下载（如无账户，请自行注册，注册是免费的） 登陆Linux系统，切换到root用户 通过FinalShell，上传下载好的JDK安装包
image-20221017163706026 创建文件夹，用来部署JDK，将JDK和Tomcat都安装部署到：/export/server 内
...
如下图：
img`},{header:"你知道哪些 JVM 分析的工具",slug:"你知道哪些-jvm-分析的工具",content:`JVM 分析的工具有很多，它们可以帮助我们监控和调优 JVM 的性能、内存、垃圾回收、线程等方面。根据不同的功能和使用方式，可以分为以下几类： 命令行工具：这些工具是 JDK 自带的，可以在命令行中执行，不需要额外的安装或配置。比如 jps 可以查看 Java 进程的信息，jstack 可以查看线程的栈信息，jmap 可以查看堆内存的使用情况，jstat 可以查看 JVM 的统计信息等。
...
观察每次GC后的堆内存空间，可以看到随着任务执行次数越来越多，GC执行后新生代能够清空，而老年代GC后的数据还是比较满的，则可以判定由于某些数据GC不掉，且该部分数据越来越多导致内存不足出现内存泄漏 在一次full GC后dump出堆内存文件，查看占用大内存的对象的GCRoot，可以看到被一个static引用着，因此得不到释放。
image-20210924162438661 最终可以确定是因为程序运行过程中一直往该static Map添加元素，而用完了不去清理掉，导致对象被该Map强引用，不会被GC掉，造成内存泄漏。 作者：奋斗扬原文阅读`},{header:"内存什么时候会出现锯齿状的波动，为什么会出现这种情况，举个例子？内存波形图是很小的锯齿形和很大的锯齿形比起来哪种好，为什么？波动很大怎么解决？",slug:"内存什么时候会出现锯齿状的波动-为什么会出现这种情况-举个例子-内存波形图是很小的锯齿形和很大的锯齿形比起来哪种好-为什么-波动很大怎么解决",content:`内存波动是指内存的使用率或者可用空间在一段时间内不断变化的现象。内存波动可能有以下几种原因： 内存泄漏：程序使用了内存，但是没有及时释放，导致内存资源不足，从而引起频繁的垃圾回收或者内存交换。
...
开销: 中等。
应用: InnoDB 使用临键锁，它是记录锁和间隙锁的组合。 \`临键锁\`锁定行记录及其前面的间隙。 提示
不同的锁策略和粒度对性能和并发性有不同的影响。选择正确的锁策略是确保高性能和数据完整性的关键。`},{header:"InnoDB 有哪几种行锁？",slug:"innodb-有哪几种行锁",content:""},{header:"InnoDB 的行锁",slug:"innodb-的行锁",content:"InnoDB 存储引擎为了实现高并发和数据一致性，提供了几种行锁。以下是 InnoDB 中的行锁类型： 记录锁 (Record Locks) 锁定一个具体的行记录。\n当对一个行记录进行读取或修改操作时，InnoDB 会使用记录锁来锁定该行。 `记录锁`锁定特定的行记录。 间隙锁 (Gap Locks) 锁定一个索引之间的间隙，但不包括记录本身。\n这种锁主要用于防止其他事务在这个间隙中插入新的记录。 `间隙锁`锁定索引之间的间隙，但不包括记录本身。 临键锁 (Next-Key Locks) 是记录锁和间隙锁的组合。\n锁定一个记录以及该记录之前的间隙。\n这种锁策略可以确保范围查询的一致性。 `临键锁`锁定行记录及其前面的间隙。 插入意向锁 (Insert Intention Locks) 是一种特殊类型的间隙锁，用于表明事务打算在某个间隙中插入一个新的记录。\n当多个事务都想在同一个间隙中插入记录时，插入意向锁可以确保这些事务按顺序执行。 `插入意向锁`表示事务打算在某个间隙中插入新记录。 提示\nInnoDB 的行锁策略旨在实现高并发操作，同时确保数据的一致性和完整性。"},{header:"InnoDB 行锁的内部实现原理是什么",slug:"innodb-行锁的内部实现原理是什么",content:""},{header:"InnoDB 行锁的内部实现原理",slug:"innodb-行锁的内部实现原理",content:"InnoDB 的行锁实现是基于其索引组织的方式。以下是其内部实现原理的详细描述： 基于索引的锁定 InnoDB 的行锁是基于索引的，无论是主键索引还是辅助索引。如果在没有索引的列上执行锁定操作，InnoDB 会使用隐藏的聚簇索引。\n这意味着，为了获得最佳的锁定性能，查询应该使用索引。 `基于索引的锁定`意味着所有的行锁操作都与某个索引关联。 锁定队列 当一个事务试图锁定一个已经被另一个事务锁定的记录时，它会进入一个锁定队列，等待前一个事务释放锁。\nInnoDB 使用死锁检测算法来检查和解决可能的死锁情况。 `锁定队列`确保事务按照它们请求锁的顺序获得锁。 多粒度锁定 InnoDB 支持多种锁定粒度，包括行锁、间隙锁和表锁。这允许它在不同的情况下选择最合适的锁定策略。\n例如，对于大范围的查询，InnoDB 可能会选择使用表锁而不是行锁。 `多粒度锁定`允许 InnoDB 根据操作的性质选择最佳的锁定策略。 意向锁 InnoDB 使用意向锁来表明一个事务希望获得一个更细粒度的锁。这是一个优化机制，用于减少锁定冲突的可能性。\n意向锁是表级别的，它们表明事务打算在表的某个部分上获得行锁。 `意向锁`是一个优化机制，用于减少锁定冲突。 记录、间隙和临键锁 InnoDB 使用记录锁来锁定单个行记录，使用间隙锁来锁定索引之间的间隙，使用临键锁来锁定记录和其前面的间隙。\n这些锁策略允许 InnoDB 在保持数据一致性的同时，实现高并发性。 `记录、间隙和临键锁`是 InnoDB 的核心锁定策略，用于实现高并发性和数据一致性。 提示\nInnoDB 的行锁实现是为了支持高并发操作，同时确保数据的完整性和一致性。"},{header:"锁是如何加载索引上的？",slug:"锁是如何加载索引上的",content:""},{header:"锁在索引上的加载方式",slug:"锁在索引上的加载方式",content:"InnoDB 的行锁是基于索引的，这意味着锁定机制与索引结构紧密相关。以下是锁如何加载到索引上的详细描述： B+树索引结构 InnoDB 使用 B+树作为其索引结构，无论是聚簇索引（主键索引）还是非聚簇索引（辅助索引）。\n锁定操作主要在这些 B+树的叶子节点上执行，因为叶子节点包含了实际的数据或指向聚簇索引的指针。 `B+树索引结构`是 InnoDB 锁定机制的基础。 记录锁 当执行一个锁定操作时，InnoDB 会在 B+树索引的相应叶子节点上设置记录锁。\n如果查询使用了索引，那么锁会直接应用到索引项上。如果没有使用索引，InnoDB 会回退到聚簇索引（隐藏的主键）。 `记录锁`直接锁定 B+树索引的叶子节点。 间隙锁 间隙锁不是锁定实际的索引记录，而是锁定两个索引记录之间的间隙。\n这种锁确保在锁定期间，没有新的记录可以插入到这个间隙中。 `间隙锁`锁定索引记录之间的空隙。 临键锁 临键锁是记录锁和间隙锁的组合。\n当一个事务锁定一个记录时，它同时锁定该记录和前面的间隙，确保范围查询的一致性。 `临键锁`锁定索引记录及其前面的间隙。 锁的传播 当使用非聚簇索引（辅助索引）进行查询并需要锁定时，InnoDB 首先在非聚簇索引上设置锁，然后再在聚簇索引上设置锁。\n这是因为非聚簇索引的叶子节点包含指向聚簇索引的指针。 `锁的传播`从非聚簇索引传递到聚簇索引。 提示\n锁在索引上的加载方式是为了确保数据的一致性和完整性，同时支持高并发操作。"},{header:"如果一张表有五个索引，一个加锁语句进来，会不会同时对五个索引加锁？",slug:"如果一张表有五个索引-一个加锁语句进来-会不会同时对五个索引加锁",content:""},{header:"对多索引表的锁定行为",slug:"对多索引表的锁定行为",content:"当一张表有多个索引时，一个加锁语句（例如SELECT ... FOR UPDATE）进来，它不会对所有的索引都加锁。锁的行为取决于查询使用的索引。以下是详细的解释： 使用的索引 当执行一个加锁语句时，InnoDB 会根据查询使用的索引来决定锁定哪个索引。\n例如，如果你的查询是基于某个特定的索引进行的，那么只有这个索引会被锁定。 `使用的索引`决定了锁定哪个索引。 聚簇索引 (主键索引) 无论查询使用哪个非聚簇索引（辅助索引），最终的锁定操作都会传播到聚簇索引，因为实际的数据行存储在聚簇索引中。\n所以，即使你的查询是基于非聚簇索引的，聚簇索引上的相应行也会被锁定。 `聚簇索引`总是涉及锁定，因为它包含实际的数据行。 锁的粒度 即使查询使用了某个索引，这并不意味着整个索引都会被锁定。锁的粒度通常是行级的，这意味着只有查询涉及的行会被锁定。 `锁的粒度`通常是行级的，不是整个索引。 提示\n简而言之，一个加锁语句不会对表中的所有索引都加锁，只会锁定查询实际使用或涉及的索引上的特定行。"}]},{path:"/blog/MYSQL%E6%95%B0%E6%8D%AE%E5%BA%93/%E9%87%8D%E8%A6%81%E7%9A%84%E4%BB%A3%E7%A0%81.html",title:"",pathLocale:"/",contents:[{header:"",slug:"",content:`├── checkstyle || -- # 代码格式检查组件
...
如果从某一个加油站走发现没油，那就直接跳没油的加油站的位置开始继续往下，因为加上第一个都走不通的话，去掉第一个肯定走不通，然后就是一直模拟就可以得到答案`},{header:"解题方法",slug:"解题方法",content:"滑动窗口"},{header:"复杂度",slug:"复杂度",content:"时间复杂度: 添加时间复杂度, 示例： O(n∗n)O(n*n)O(n∗n) 空间复杂度: 添加空间复杂度, 示例： O(1)O(1)O(1)"},{header:"Code",slug:"code",content:`class Solution { public int canCompleteCircuit(int[] gas, int[] cost) { int a = 0; int b = 0; for(int i = 0;i < gas.length;i++){ a += gas[i]; b += cost[i]; } if(a < b){ return -1; } int res = 0; for(int i = 0;i < gas.length;i++){ //从i触发在第一个加油站加油 res = 0; res += gas[i]; //前往下一个加油站 int j = i + 1; for(;j < gas.length;j++){ res -= cost[j - 1]; if(res < 0){ break; } res += gas[j]; } if(res < 0){ i = --j; continue; } for(int k = 0;k <= i;k++){ if(k == 0){ res -= cost[cost.length - 1]; if(res < 0){ break; } res += gas[k]; }else{ res -= cost[k - 1]; if(res < 0){ break; } res += gas[k]; } } if(res < 0){ i = j; }else{ res = i; break; } } return res; }
}`}]},{path:"/code/%E5%8A%9B%E6%89%A3/%E5%92%8C%E4%B8%BA-K-%E7%9A%84%E5%AD%90%E6%95%B0%E7%BB%84.html",title:"和为 K 的子数组",pathLocale:"/",contents:[{header:"",slug:"",content:"Problem: 560. 和为 K 的子数组"},{header:"思路",slug:"思路",content:"前缀和思想，先计算出数组的前缀和，然后通过双指针算法，计算出所有的可能"},{header:"解题方法",slug:"解题方法",content:"前缀和和双指针"},{header:"复杂度",slug:"复杂度",content:"时间复杂度: 添加时间复杂度, 示例： O(nlogn)O(nlogn)O(nlogn) 空间复杂度: 添加空间复杂度, 示例： O(n)O(n)O(n)"},{header:"Code",slug:"code",content:`class Solution { public int subarraySum(int[] nums, int k) { //前缀和思想 int[] sum = new int[nums.length]; sum[0] = nums[0]; for(int i = 1;i < nums.length;i++){ sum[i] = sum[i - 1] + nums[i]; } int count = 0; for(int i = 0;i < nums.length;i++){ if(sum[i] == k){ count++; } for(int j = i + 1;j < nums.length;j++){ if(sum[j] - sum[i] == k){ count++; } } } return count; }
...
O(n)O(n)O(n)，因为我们只遍历数组一次。 空间复杂度:
O(1)O(1)O(1)，我们只使用了常数级别的额外空间。`},{header:"Code",slug:"code",content:`class Solution { public int maxArea(int[] height) { int left = 0; int right = height.length - 1; int max = 0; int min = 0; while(left < right){ min = Math.min(height[left],height[right]); max = Math.max((right - left) * min,max); while(height[left] <= min && left < right){ left++; } while(height[right] <= min && left < right){ right--; } } return max; }
}
...
线程的创建方式
线程池的运行原理
AQS`}]},{path:"/interview/%E6%AF%8F%E6%97%A5%E4%B8%80%E9%9D%A2/%E5%BE%97%E7%89%A9%E4%B8%80%E9%9D%A20906.html",title:"得物Java一面",pathLocale:"/",contents:[{header:"类加载机制",slug:"类加载机制",content:`类加载机制默认的是双亲委派机制，JDK提供的类加载器一共有三个
...
image-20230906110606521
如果不计算维护 Remembered Set 的操作，G1 收集器的运作大致可划分为以下几个步骤: 初始标记
并发标记
...
递归公式如下：
f(1,m)=0f(n,m)=(f(n−1,m)+m−1)%n+1
f(1, m) = 0 \\\\ f(n, m) = (f(n-1, m) + m - 1) \\% n + 1
f(1,m)=0f(n,m)=(f(n−1,m)+m−1)%n+1
...
image-20230908120756888 Read View 有四个重要的字段： m_ids ：指的是在创建 Read View 时，当前数据库中「活跃事务」的事务 id 列表，注意是一个列表，“活跃事务”指的就是，启动了但还没提交的事务。 min_trx_id ：指的是在创建 Read View 时，当前数据库中「活跃事务」中事务 id 最小的事务，也就是 m_ids 的最小值。 max_trx_id ：这个并不是 m_ids 的最大值，而是创建 Read View 时当前数据库中应该给下一个事务的 id 值，也就是全局事务中最大的事务 id 值 + 1； creator_trx_id ：指的是创建该 Read View 的事务的事务 id。 image-20230908120846416 一个事务去访问记录的时候，除了自己的更新记录总是可见之外，还有这几种情况： 如果记录的 trx_id 值小于 Read View 中的 min_trx_id 值，表示这个版本的记录是在创建 Read View 前已经提交的事务生成的，所以该版本的记录对当前事务可见。 如果记录的 trx_id 值大于等于 Read View 中的 max_trx_id 值，表示这个版本的记录是在创建 Read View 后才启动的事务生成的，所以该版本的记录对当前事务不可见。 如果记录的 trx_id 值在 Read View 的
min_trx_id
和
max_trx_id
...
-p 9200:9200：端口映射配置 在浏览器中输入：http://192.168.150.101:9200 即可看到elasticsearch的响应结果：
image-20210506101053676`},{header:"2.部署kibana",slug:"_2-部署kibana",content:"kibana可以给我们提供一个elasticsearch的可视化界面，便于我们学习。"},{header:"2.1.部署",slug:"_2-1-部署",content:`运行docker命令，部署kibana
docker run -d \\
--name kibana \\
...
此时，在浏览器输入地址访问：http://192.168.150.101:5601，即可看到结果`},{header:"2.2.DevTools",slug:"_2-2-devtools",content:`kibana中提供了一个DevTools界面：
image-20210506102630393
这个界面中可以编写DSL来操作elasticsearch。并且对DSL语句有自动补全功能。`},{header:"3.安装IK分词器",slug:"_3-安装ik分词器",content:""},{header:"3.1.在线安装ik插件（较慢）",slug:"_3-1-在线安装ik插件-较慢",content:`# 进入容器内部
...
说明plugins目录被挂载到了：/var/lib/docker/volumes/es-plugins/_data 这个目录中。`},{header:"2）解压缩分词器安装包",slug:"_2-解压缩分词器安装包",content:`下面我们需要把课前资料中的ik分词器解压缩，重命名为ik
image-20210506110249144`},{header:"3）上传到es容器的插件数据卷中",slug:"_3-上传到es容器的插件数据卷中",content:`也就是/var/lib/docker/volumes/es-plugins/_data ：
image-20210506110704293`},{header:"4）重启容器",slug:"_4-重启容器",content:`# 4、重启容器
docker restart es
# 查看es日志
...
image-20230901124428699`}]},{path:"/blog/%E9%A1%B9%E7%9B%AE/12306/%E6%9F%A5%E8%AF%A2%E8%BD%A6%E7%A5%A8.html",title:"查询车票",pathLocale:"/",contents:[{header:"查询车票功能实现",slug:"查询车票功能实现",content:`/** * 根据条件查询车票 */
...
image-20230904215756289
image-20230904215810458`},{header:"查询列车",slug:"查询列车",content:"可以看到，在列车与站点之间的关系表中，还有一列，是列车的id，可以直接拿到列车的id，然后查询是那一趟列车，接下来就是查询站点之间的票了，大概就是根据从刚才的查询中查到的列车id，去查询这一趟列车在这一个区间的票，可以分为很多种，一等座、二等座、高铁、普快等等。"},{header:"查询票价",slug:"查询票价",content:`根据查询出来的列车封装成带有票价、出发地点、目的地、出发时间、各种作为类型的一趟火车，现在火车有了，还需要查询余票，以及票价
...
image-20230904220623134
image-20230904220636784
大概就是这样，这张表会存储每一趟列车的出发站点与目的地，座位类型与票价等`},{header:"查数据库",slug:"查数据库",content:`查询完座位类型，票价，现在需要查询余票了，余票是放在Redis缓存中的，所以需要从Redis中查询，首先就是获取缓存对象，拼接key等
...
image-20230904223129816`},{header:"大概思路",slug:"大概思路",content:`1、验证参数
2、查询站点信息
3、查询站点之间的列车
4、查询列车余票
5、构建返回数据
最复杂的就是查询余票，因为余票是写入到缓存中的，所以需要查缓存，查不到还要去查数据库，然后再写入缓存，这是缓存中存放的票量数据
image-20230904224314668`}]},{path:"/blog/%E9%A1%B9%E7%9B%AE/12306/%E8%B4%A3%E4%BB%BB%E9%93%BE%E6%A8%A1%E5%BC%8F.html",title:"责任链模式",pathLocale:"/",contents:[{header:"什么是责任链模式",slug:"什么是责任链模式",content:`责任链模式（Chain of Responsibility Pattern）是一种行为设计模式，它为请求创建了一个接收者对象的链。这个模式给予请求的类型，将请求的发送者和接收者解耦。这允许多个对象处理请求，或者将请求传递给链中的下一个对象。责任链模式通常在有多个处理级别或者处理步骤时使用。
