import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c as l,d as n,e as s,a as t,b as a}from"./app-fe15e87e.js";const c={},r=a(`<h1 id="安装elasticsearch" tabindex="-1"><a class="header-anchor" href="#安装elasticsearch" aria-hidden="true">#</a> 安装elasticsearch</h1><h1 id="_1-部署单点es" tabindex="-1"><a class="header-anchor" href="#_1-部署单点es" aria-hidden="true">#</a> 1.部署单点es</h1><h2 id="_1-1-创建网络" tabindex="-1"><a class="header-anchor" href="#_1-1-创建网络" aria-hidden="true">#</a> 1.1.创建网络</h2><p>因为我们还需要部署kibana容器，因此需要让es和kibana容器互联。这里先创建一个网络：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> network create es-net
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_1-2-加载镜像" tabindex="-1"><a class="header-anchor" href="#_1-2-加载镜像" aria-hidden="true">#</a> 1.2.加载镜像</h2><p>这里我们采用elasticsearch的7.12.1版本的镜像，这个镜像体积非常大，接近1G。不建议大家自己pull。</p><p>课前资料提供了镜像的tar包：</p><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210510165308064.png" alt="image-20210510165308064" tabindex="0" loading="lazy"><figcaption>image-20210510165308064</figcaption></figure><p>大家将其上传到虚拟机中，然后运行命令加载即可：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 导入数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>命令解释：</p><ul><li><code>-e &quot;cluster.name=es-docker-cluster&quot;</code>：设置集群名称</li><li><code>-e &quot;http.host=0.0.0.0&quot;</code>：监听的地址，可以外网访问</li><li><code>-e &quot;ES_JAVA_OPTS=-Xms512m -Xmx512m&quot;</code>：内存大小</li><li><code>-e &quot;discovery.type=single-node&quot;</code>：非集群模式</li><li><code>-v es-data:/usr/share/elasticsearch/data</code>：挂载逻辑卷，绑定es的数据目录</li><li><code>-v es-logs:/usr/share/elasticsearch/logs</code>：挂载逻辑卷，绑定es的日志目录</li><li><code>-v es-plugins:/usr/share/elasticsearch/plugins</code>：挂载逻辑卷，绑定es的插件目录</li><li><code>--privileged</code>：授予逻辑卷访问权</li><li><code>--network es-net</code> ：加入一个名为es-net的网络中</li><li><code>-p 9200:9200</code>：端口映射配置</li></ul>`,17),u={href:"http://192.168.150.101:9200",target:"_blank",rel:"noopener noreferrer"},d=a(`<figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210506101053676.png" alt="image-20210506101053676" tabindex="0" loading="lazy"><figcaption>image-20210506101053676</figcaption></figure><h1 id="_2-部署kibana" tabindex="-1"><a class="header-anchor" href="#_2-部署kibana" aria-hidden="true">#</a> 2.部署kibana</h1><p>kibana可以给我们提供一个elasticsearch的可视化界面，便于我们学习。</p><h2 id="_2-1-部署" tabindex="-1"><a class="header-anchor" href="#_2-1-部署" aria-hidden="true">#</a> 2.1.部署</h2><p>运行docker命令，部署kibana</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查看运行日志，当查看到下面的日志，说明成功：</p><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210109105135812.png" alt="image-20210109105135812" tabindex="0" loading="lazy"><figcaption>image-20210109105135812</figcaption></figure>`,11),v={href:"http://192.168.150.101:5601",target:"_blank",rel:"noopener noreferrer"},k=a(`<h2 id="_2-2-devtools" tabindex="-1"><a class="header-anchor" href="#_2-2-devtools" aria-hidden="true">#</a> 2.2.DevTools</h2><p>kibana中提供了一个DevTools界面：</p><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210506102630393.png" alt="image-20210506102630393" tabindex="0" loading="lazy"><figcaption>image-20210506102630393</figcaption></figure><p>这个界面中可以编写DSL来操作elasticsearch。并且对DSL语句有自动补全功能。</p><h1 id="_3-安装ik分词器" tabindex="-1"><a class="header-anchor" href="#_3-安装ik分词器" aria-hidden="true">#</a> 3.安装IK分词器</h1><h2 id="_3-1-在线安装ik插件-较慢" tabindex="-1"><a class="header-anchor" href="#_3-1-在线安装ik插件-较慢" aria-hidden="true">#</a> 3.1.在线安装ik插件（较慢）</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 进入容器内部</span>
...
<span class="token function">docker</span> restart elasticsearch
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>说明plugins目录被挂载到了：<code>/var/lib/docker/volumes/es-plugins/_data </code>这个目录中。</p><h3 id="_2-解压缩分词器安装包" tabindex="-1"><a class="header-anchor" href="#_2-解压缩分词器安装包" aria-hidden="true">#</a> 2）解压缩分词器安装包</h3><p>下面我们需要把课前资料中的ik分词器解压缩，重命名为ik</p><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210506110249144.png" alt="image-20210506110249144" tabindex="0" loading="lazy"><figcaption>image-20210506110249144</figcaption></figure><h3 id="_3-上传到es容器的插件数据卷中" tabindex="-1"><a class="header-anchor" href="#_3-上传到es容器的插件数据卷中" aria-hidden="true">#</a> 3）上传到es容器的插件数据卷中</h3><p>也就是<code>/var/lib/docker/volumes/es-plugins/_data </code>：</p><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210506110704293.png" alt="image-20210506110704293" tabindex="0" loading="lazy"><figcaption>image-20210506110704293</figcaption></figure><h3 id="_4-重启容器" tabindex="-1"><a class="header-anchor" href="#_4-重启容器" aria-hidden="true">#</a> 4）重启容器</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 4、重启容器</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-3-扩展词词典" tabindex="-1"><a class="header-anchor" href="#_3-3-扩展词词典" aria-hidden="true">#</a> 3.3 扩展词词典</h2><p>随着互联网的发展，“造词运动”也越发的频繁。出现了很多新的词语，在原有的词汇列表中并不存在。比如：“奥力给”，“传智播客” 等。</p><p>所以我们的词汇也需要不断的更新，IK分词器提供了扩展词汇的功能。</p><p>1）打开IK分词器config目录：</p><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20210506112225508.png" alt="image-20210506112225508" tabindex="0" loading="lazy"><figcaption>image-20210506112225508</figcaption></figure><p>2）在IKAnalyzer.cfg.xml配置文件内容添加：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token prolog">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://jackchen-note.oss-cn-beijing.aliyuncs.com/elasticsearchimage-20201115230900504.png" alt="image-20201115230900504" tabindex="0" loading="lazy"><figcaption>image-20201115230900504</figcaption></figure><p>日志中已经成功加载ext.dic配置文件</p><p>5）测试效果：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>GET /_analyze
<span class="token punctuation">{</span>
  <span class="token property">&quot;analyzer&quot;</span><span class="token operator">:</span> <span class="token string">&quot;ik_max_word&quot;</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,64);function m(b,g){const e=p("ExternalLinkIcon");return o(),l("div",null,[r,n("p",null,[s("在浏览器中输入："),n("a",u,[s("http://192.168.150.101:9200"),t(e)]),s(" 即可看到elasticsearch的响应结果：")]),d,n("p",null,[s("此时，在浏览器输入地址访问："),n("a",v,[s("http://192.168.150.101:5601"),t(e)]),s("，即可看到结果")]),k])}const f=i(c,[["render",m],["__file","安装elasticsearch.html.vue"]]);export{f as default};
