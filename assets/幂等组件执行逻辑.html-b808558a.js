import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,b as e}from"./app-2b5ca486.js";const t={},p=e(`<h2 id="幂等组件执行流程" tabindex="-1"><a class="header-anchor" href="#幂等组件执行流程" aria-hidden="true">#</a> 幂等组件执行流程</h2><h4 id="在项目中实现了一个幂等注解的类" tabindex="-1"><a class="header-anchor" href="#在项目中实现了一个幂等注解的类" aria-hidden="true">#</a> 在项目中实现了一个幂等注解的类</h4><p>该注解通过AOP的形式使用在需要增强的方法上面，然后通过Aspect动态代理拿到注解上面的值</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 幂等注解
 *
 *
